...
jarak:{
  ...
  abilities:[
    {key:'Q', name:'Whirling Axes', cast:'point', range:560, mana:[50,55,60,65], cd:[11,10,9,8],
     scaled:'d',
     desc:'Fling three axes in a spread, each dealing %d damage and slowing by 30% for 2s. The axes pass through creeps and stop on the first hero they hit.',
     val:[80,125,170,215]},
    {key:'W', name:'Fervor', cast:'self', grants:'fervor', mana:[20,20,20,20], cd:[3,3,3,3],
     desc:'Passive: every blow landed on the SAME target grants +%d% attack speed, stacking up to 4/5/7/8 times by rank. Switch targets and it is gone. ACTIVE: change grip — throw axes at 520 range, or come back to the blade for +35% attack speed and a %p% chance to root on every swing.',
     val:[16,23,30,37], val2:[8,11,15,18], stacks:[4,5,7,8]},
    {key:'E', name:'Frenzied Charge', cast:'point', range:420, mana:[45,50,55,60], cd:[18,16,14,12],
     desc:'Channel for up to 1s, then charge toward the cursor. Cast again to release early. On release Jarak gains %d Fervor stacks, reduced if the channel was cut short. The granted stacks carry onto the next target he attacks.',
     val:[1,2,3,4]},
